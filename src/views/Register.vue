  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    <div class="max-w-md w-full">
      ...
      <form class="space-y-4" @submit.prevent="register">
        ...
        <div class="relative text-gray-400">
          ...
          <input
            ...
            v-bind:class="{ 'border-red-700': errors.phone_number }"
        ...
        <div class="relative text-gray-400">
          ...
          <input
            ...
            v-bind:class="{ 'border-red-700': errors.password_confirmation }"
      ...
      <div class="mt-2 text-sm text-gray-600">
        Not registered yet? <a @click="$router.push({ name: 'login' })" class="font-medium text-indigo-600 hover:text-indigo-500">Login</a>
      </div>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  methods: {
    ...
    register() {
      ...
      let url = import.meta.env.VITE_API_BASE_URL + 'register'
