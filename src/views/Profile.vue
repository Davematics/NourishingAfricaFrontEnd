    ...
    <div class="flex items-center space-x-1 text-xs">
     ...
     <form  @submit.prevent="update('update')" id="update">
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <input type="number" class="w-full bg-gray-100 p-2 mt-2 mb-3"  v-bind:class="{ 'border-red-700': errors.phone_number }"
            v-model="phone_number"  name="phone_number" />
            <span
        ...
        <input type="text" name="country" class="w-full bg-gray-100 p-2 mt-2 mb-3"  v-bind:class="{ 'border-red-700': errors.country }"
            v-model="country" />
            <span
                    v-if="errors.country"
                    class="block text-sm text-red-700 -mt-2 mb-4"
