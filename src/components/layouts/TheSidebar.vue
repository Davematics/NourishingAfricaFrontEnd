<template>
  <aside class="hidden w-64 bg-gray-800 sm:block" id="sideMenu">
    <div class="py-3 text-xl uppercase text-center tracking-widest bg-gray-900 border-b-2 border-gray-800 mb-8">
      <router-link to="/" class="text-white">Nourishing Africa</router-link>
    </div>
